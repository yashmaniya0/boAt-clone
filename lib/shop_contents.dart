...
class _ShopContentsState extends State<ShopContents>  with TickerProviderStateMixin {
  ...
  Widget _buildHeadphonesTab(){
    return Container(
      ...
      child: ListView(
        children: [
          _buildProductCard('assets/products/headphones/rockeraz550.jpg', 'boAt Rockerz 255',5,329742, 1799, 4999),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/rockerz370.png', 'boAt Rockerz 255 F',4,56842, 999, 2490),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/rockerz400.png', 'boAt Rockerz 255 Pro',5,248156, 1299, 2990),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/rockerz425.jpg', 'boAt Rockerz 255 Neo',4,114264, 1299, 2990),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/rockerz450.jpg', 'boAt Rockerz 260',4,426574, 1399, 3990),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/rockerz510.jpg', 'boAt Rockerz 261',5,345116, 1399, 3490),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/rockerz650.png', 'boAt Rockerz 333',5,146529, 1699, 3990),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/nirvana1007anc.png', 'boAt Rockerz 333 Pro',5,16214, 9999, 19999),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/immortal1300.png', 'boAt Rockerz 375',4,26842, 2899, 9990),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/immortal200.png', 'boAt TRebel 255 Pro',4,28456, 1499, 4990),
          SizedBox(height: 7,),
          _buildProductCard('assets/products/headphones/immortal700.png', 'boAt 100 Wireless',4,12489, 2399, 6990),
          SizedBox(height: 7,),
        ],
      ),
    );
